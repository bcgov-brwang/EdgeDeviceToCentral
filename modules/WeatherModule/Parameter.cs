...
namespace Microsoft.Azure.Devices.Client.Samples
{
    ...
    internal class Parameters
    {
        ...
        public string DeviceSecurityType { get; set; } = "dps";// Environment.GetEnvironmentVariable("IOTHUB_DEVICE_SECURITY_TYPE");
        ...
        public string DpsEndpoint { get; set; } = "global.azure-devices-provisioning.net";// Environment.GetEnvironmentVariable("IOTHUB_DEVICE_DPS_ENDPOINT");
        ...
        public string DpsIdScope { get; set; } = "0ne003E689C";// Environment.GetEnvironmentVariable("IOTHUB_DEVICE_DPS_ID_SCOPE");
        ...
        public string DeviceId { get; set; } = "WeatherStation-01";// Environment.GetEnvironmentVariable("IOTHUB_DEVICE_DPS_DEVICE_ID");
        ...
        public string DeviceSymmetricKey { get; set; } = "Uk+/i1jVRXVtOZY8XsZ1zf26v8yS60MWmfir71oH20g=";// Environment.GetEnvironmentVariable("IOTHUB_DEVICE_DPS_DEVICE_KEY");
        ...
        public bool Validate(ILogger logger)
        {
            ...
            DpsIdScope = "0ne003E689C";
            DeviceId = "WeatherStation-01";
            DeviceSymmetricKey = "Uk+/i1jVRXVtOZY8XsZ1zf26v8yS60MWmfir71oH20g=";
